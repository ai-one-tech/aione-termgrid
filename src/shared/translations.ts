...
export const TRANSLATIONS = {
  en: {
    ...
    initialDelay: 'Startup Delay (ms)',
    initialDelayDescription: 'Time to wait for shell to load before sending the initial command.',
  ...
  zh: {
    ...
    initialDelay: '启动延迟 (毫秒)',
    initialDelayDescription: '等待 Shell 加载完成后再发送初始命令的时间。',
    borderColor: '边框颜色',
    envFiles: '环境变量文件',
